...
export const cvData = {
  ...
  experience: [
    { role: 'Analista de Infraestrutura & Suporte de TI N2', company: 'Colégio Jean Piaget', period: 'Jan/2024 - Presente', tasks: ['Suporte técnico especializado (N2) e apoio a usuários.', 'Manutenção da infraestrutura de rede, servidores e equipamentos de rack.', 'Elaboração de laudos técnicos e documentação de sistemas.','Realizar cadastro e gerenciamento de usuários em redes, e-mails e sistemas','Monitorar o sistema Zabbix, direcionando alertas aos responsáveis.','Suporte ao sistema ERP GVDasa.','Troca e passagem de cabeamento de rede.','Manutenção preventiva e corretiva de computadores, Chromebooks, Notebooks ou qualquer outro equipamento eletronico.','Suporte em Help Desk para toda a comunidade acadêmica.','Organização dos equipamentos de TI','Solicitação de compras e reposição de equipamentos de TI','Instalação e manutenção do Hyper-V',' Configuração do PFSense e configuração do Proxy Transparente com Squid e Squid Guard'] },
